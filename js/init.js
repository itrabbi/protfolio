jQuery(document).ready(function () {
    ...
    rabbi_tm_modalbox();
    rabbi_tm_movingbox();
    rabbi_tm_page_transition();
    rabbi_tm_trigger_menu();
    rabbi_tm_service_popup();
    rabbi_tm_experience_popup();
    rabbi_tm_modalbox_news();
    rabbi_tm_modalbox_portfolio();
    rabbi_tm_cursor();
    rabbi_tm_imgtosvg();
    rabbi_tm_popup();
    rabbi_tm_data_images();
    rabbi_tm_contact_form();
    rabbi_tm_owl_carousel();
    rabbi_tm_scrollable();
    rabbi_tm_stickyy();
    rabbi_tm_down();
    rabbi_tm_location();
...
function rabbi_tm_modalbox() {
    "use strict";
    jQuery('.rabbi_tm_all_wrap').prepend('<div class="rabbi_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="fa-solid fa-xmark"></i></a></div><div class="description_wrap"></div></div></div>');
}
function rabbi_tm_movingbox() {
    "use strict";
    var news = jQuery('.rabbi_tm_news');
    if (news.length) {
        if (!$('.movingbox').length) {
...
function rabbi_tm_page_transition() {
    "use strict";
    var section = jQuery('.rabbi_tm_section');
...
function rabbi_tm_trigger_menu() {
    "use strict";
...
function rabbi_tm_menu_closer() {
    "use strict";
    var ww = jQuery(window).width();
    if (ww >= 1040) {
        jQuery('.rabbi_tm_mobile_menu').removeClass('opened');
        jQuery('.rabbi_tm_topbar .trigger .hamburger').removeClass('is-active');
    }
}
function rabbi_tm_experience_popup() {
    "use strict";
...
function rabbi_tm_service_popup() {
    "use strict";
    var modalBox = jQuery('.rabbi_tm_modalbox');
...
function rabbi_tm_modalbox_news() {
    "use strict";
    var modalBox = jQuery('.rabbi_tm_modalbox');
...
function rabbi_tm_modalbox_portfolio() {
    "use strict";
    var modalBox = jQuery('.rabbi_tm_modalbox');
...
function rabbi_tm_owl_carousel() {
    ...
    var carousel2 = jQuery('.rabbi_tm_partners .owl-carousel');
    ...
    rabbi_tm_imgtosvg();
    var carousel3 = jQuery('.rabbi_tm_portfolio .owl-carousel');
    var rtlMode = false;
...
function rabbi_tm_scrollable() {
    ...
    var avatarHeight = jQuery('.rabbi_tm_sidebar .author').outerHeight();
    var scrollable = jQuery('.rabbi_tm_sidebar .menu.scrollable');
    var verMenu = jQuery('.rabbi_tm_sidebar .menu');
    var copyright = jQuery('.rabbi_tm_sidebar .copyright').outerHeight() + spacing;
    verMenu.css({
